...
describe "Admin leaderboards", type: :system, js: true do
  ...
  it "can create a leaderboard" do
    visit("/admin/plugins/community-gamification")
    ...
    expect(page).to have_current_path(
      "/admin/plugins/community-gamification/leaderboards/#{CommunityGamification::GamificationLeaderboard.last.id}",
    )
    ...
    expect(::CommunityGamification::GamificationLeaderboard.last).to have_attributes(
      name: "My leaderboard",
  ...
  context "when there is an existing leaderboard" do
    ...
    it "can delete a leaderboard" do
      ...
      expect(::CommunityGamification::GamificationLeaderboard.exists?(leaderboard.id)).to eq(false)
    end
  end
end
