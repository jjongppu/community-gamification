...
class CommunityGamification::AdminGamificationLeaderboardController < Admin::AdminController
  requires_plugin CommunityGamification::PLUGIN_NAME

  def index
    render_serialized(
      { leaderboards: CommunityGamification::GamificationLeaderboard.all },
  ...
  def show
    render json:
             LeaderboardSerializer.new(
               CommunityGamification::GamificationLeaderboard.find(params[:id]),
             )
  end
  ...
  def create
    ...
    leaderboard =
      CommunityGamification::GamificationLeaderboard.new(
        name: params[:name],
  ...
  def update
    ...
    leaderboard = CommunityGamification::GamificationLeaderboard.find(params[:id])
  ...
  def recalculate_scores
    CommunityGamification::RecalculateScoresRateLimiter.perform!
