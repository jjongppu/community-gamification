...
import AdminCreateLeaderboard from "discourse/plugins/community-gamification/admin/components/admin-create-leaderboard";
...
export default RouteTemplate(
  <template>
    ...
    <div class="community-gamification__leaderboards admin-detail">
                ...
                <tr id={{concat "leaderboard-admin__row-" leaderboard.id}}>
                  ...
                  <td style="width: 120px">
                    <div class="leaderboard-admin__listitem-action">
                      <LinkTo
                        @route="adminPlugins.show.community-gamification-leaderboards.show"
                        @model={{leaderboard}}
