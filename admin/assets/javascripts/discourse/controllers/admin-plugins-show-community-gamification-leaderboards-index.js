...
import RecalculateScoresForm from "discourse/plugins/community-gamification/discourse/components/modal/recalculate-scores-form";

export default class AdminPluginsShowCommunityGamificationLeaderboardsIndexController extends Controller {
  @service modal;
  @service dialog;
  @service toasts;
