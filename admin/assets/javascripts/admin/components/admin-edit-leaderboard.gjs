...
import PeriodInput from "discourse/plugins/community-gamification/discourse/components/period-input";
  ...
  async save(data) {
    try {
      ...
      await this.router.transitionTo(
        "adminPlugins.show.community-gamification-leaderboards.index"
      );
